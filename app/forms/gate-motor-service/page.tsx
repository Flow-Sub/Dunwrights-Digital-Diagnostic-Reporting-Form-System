...
import { GateMotorServiceForm } from "@/components/gate-motor-service-form"

export default function GateMotorServicePage() {
      ...
      <header className="border-b border-border bg-card">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Gate Motor Service Form</p>
          </div>
